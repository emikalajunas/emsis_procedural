...
//check if button create backup is pushed
if (isset($_POST['create_backup'])){

define("DB_USER", 'addparklt_emsis');
define("DB_PASSWORD", 'AldonasPupkiz34');
define("DB_NAME", 'addparklt_emsis');
...
class Backup_Database {
    ...
    public function __construct($host, $username, $passwd, $dbName, $charset = 'utf8') {
        ...
        $this->backupFile              = 'emsis_backup-'.$this->dbName.'-'.date("Ymd_His", time()).'.sql';
    ...
    public function backupTables($tables = '*') {
        try {
            ...
            foreach($tables as $table) {
                $this->obfPrint("Kuriama atsarginė kopija `".$table."` lentelės...".str_repeat('.', 50-strlen($table)), 0, 0);
    ...
    protected function gzipBackupFile($level = 9) {
        ...
        $this->obfPrint('Suspaudžiamas failas ' . $dest . '... ', 1, 0);
...
$backupDatabase->obfPrint('Procedūra atlikta: ' . $result, 1);
				...
				<table class="table table-sm table-bordered table-hover">
                    <thead>
                        <form action ="" method="post" enctype="multipart/form-data">
                            <input class="btn btn-primary" type="submit" name="create_backup" value="Sukurti kopiją">
                       </form>
                     </thead>
                </table>
